...
import { addUser, deleteUser, authentication, logInSucsess, logInError, logOut } from "./userManager";
...
export const sigInAction = (login: string, password: string) => async (dispatch: AppDispatch) => {
    try {
        ...
        console.log(4);
        dispatch(logInError("Oops... some kind of server problem, please try again later"));
    }
}